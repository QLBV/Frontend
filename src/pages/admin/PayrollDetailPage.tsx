  ...
  return (
    <AdminSidebar>
      <div className="space-y-6">
        <Button variant="ghost" className="mb-2 pl-0" onClick={() => navigate("/admin/salary")}>
            ...
            <CardContent className="space-y-4">
              ...
              {payroll.commission && (
                <div>
                  ...
                  <p className="font-semibold text-slate-900">
                    {payroll.commission.toLocaleString("vi-VN")} VND
                  </p>
                </div>
              )}
              ...
              <div className="pt-4 border-t">
                ...
                <p className="text-2xl font-bold text-emerald-600">
                  {payroll.totalSalary.toLocaleString("vi-VN")} VND
                </p>
              </div>
            </CardContent>
          </Card>
